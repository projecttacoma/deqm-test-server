...
const testParamWithExport = require('./fixtures/parametersObjs/paramWithExport.json');
...
const testParamInvalidExport = require('./fixtures/parametersObjs/paramInvalidExport.json');
