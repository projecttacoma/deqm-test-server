...
- To upload all the dqm-content-qicore-2025 measure bundles, `git clone` the [dqm-content-qicore-2025 repo](https://github.com/cqframework/dqm-content-qicore-2025) into the root directory of the `deqm-test-server` repository. Run `npm run upload-bundles`. This runs a script that uploads all the measure bundle resources to the appropriate Mongo collections.
